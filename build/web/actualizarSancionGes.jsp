<%-- 
    Document   : actualizarSancionGes
    Created on : 3/12/2021, 02:44:52 AM
    Author     : duban
--%>
        ...
        %>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-2">
                            <label for=""></label>
                        <button value="7" name="opcion" class="btn btn-info btn-block">Actualizar</button>
                    </div>
                    </div>
                  </form>
                  </div>
                  <%}%>
                  <a href="consultarSancionGes.jsp">Volver</a>
                </div>
