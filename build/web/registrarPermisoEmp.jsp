...
<body>
              ...
              <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="container">
                    ...
                    <select class="form-control" name="textEstado" id="" required>
                        <option name="textEstado">Pendiente</option>  
  ...
  <script>
    ...
    if (error) {
        swal("Error", "No se pudo registrar el PERMISO, por favor verifique que halla completado todos los campos.", "error");
    }
    const exito=<%=request.getParameter("mensajeExito")%>;
    if(exito){
        swal("¡Excelente!", "El permiso se registró correctamente.", "success")
    }
