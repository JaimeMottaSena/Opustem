<%-- 
    Document   : consultarPermisoGer
    Created on : 2/12/2021, 11:41:06 PM
    Author     : user
--%>
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="consultarPermisoGer.jsp">Consultar Permisos</a></li>
                   <li><a class="nav-link" href="consultarTipoPermiso.jsp">Consultar Tipo de Permisos</a></li>
            ...
            <tr>
                ...
                <td>
                  ...
                  <form method="post" action="Permiso">
                     ...
                     <input type="text" name="textEstado" value="<%=PerVO.getEstadoPermiso().equals("aprobado")?"reprobado":"aprobado"%>">
                                            <input type="text" name="textId" value="<%=PerVO.getIdPermiso()%>">
                                             </div>
                                            <button value="12"  class=" btn btn-info"  name="opcion" id="adf"  >
                                                <%=PerVO.getEstadoPermiso().equals("aprobado")?"reprobar":"aprobar"%></button>
