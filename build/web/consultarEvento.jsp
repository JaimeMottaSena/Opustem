...
<body>
    ...
    <div class="main-wrapper main-wrapper-1">
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                 <li><a class="nav-link" href="registrarEvento.jsp">Registrar Eventos</a></li>
      ...
      <div class="main-content">
        ...
        <thead>
         ...
         <br>
            <form method="post" action="GenerarEventoPDF.jsp" target="_black">
                          <input type="hidden" >
  ...
  <script>
    ...
    if (error) {
        swal("Error", "No se pudo registrar el evento, por favor verifique.", "error");
    }
    const exito=<%=request.getParameter("mensajeExito")%>;
    if(exito){
        swal("¡Excelente!", "El evento se registró correctamente.", "success")
    }
