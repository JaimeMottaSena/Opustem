<%-- 
    Document   : actualizarSancionJefe
    Created on : 3/12/2021, 03:14:25 AM
    Author     : duban
--%>
...
<head>
  ...
  <title>Actualizar Sanción</title>
  <!-- General CSS Files -->
        ...
        %>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="textDescripcion" class="form-control" id="" cols="10" rows="5"><%=sanVO.getDescripcion()%></textarea>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-2">
                            <label for=""></label>
                        <button value="8" name="opcion" class="btn btn-info btn-block">Actualizar</button>
                    </div>
                    </div>
                  </form>
                  </div>
                  <%}%>
                  <a href="consultarSancionJefe.jsp">Volver</a>
                </div>
