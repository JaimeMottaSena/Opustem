<%-- 
    Document   : consultarSancionGes
    Created on : 3/12/2021, 01:13:37 AM
    Author     : duban
--%>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="menu_Gestion.jsp"> <img alt="image" src="assets/img/opus.png" class="header-logo" /> <span
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="consultarSancionGes.jsp">Consultar Sanciones</a></li>
                <li><a class="nav-link" href="registrarSancionGes.jsp">Registrar Sanción</a></li>
              </ul>
            </li>
          </ul>
        </aside>
          ...
          <div class="section-body">
            ...
            <tr>
                ...
                <td>
                    ...
                    <button value="12" class="btn btn-warning btn-block" name="opcion" >Editar</button>
                    
                  <input type="hidden"  name="textId" value="<%=SanVO.getIdSancion()%>">
                     <button value="9" class="btn btn-danger btn-block" onclick="Borrar(<%=SanVO.getIdSancion()%>)" name="opcion" >Eliminar</button>
                    </form>
                </td>
            </tr>
        </tbody>
                      ...
                      <form method="post" action="GenerarSancionPDF.jsp" target="_black">
                          <input type="hidden" >
                          <button class="btn btn-info btn-block">Generar PDF</button>
                      </form>
            </div>
          </div>
        </section>
