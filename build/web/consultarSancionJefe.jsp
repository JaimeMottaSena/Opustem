<%-- 
    Document   : consultarSancionJefe
    Created on : 3/12/2021, 02:25:47 AM
    Author     : duban
--%>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="menu_Jefe.jsp"> <img alt="image" src="assets/img/opus.png" class="header-logo" /> <span
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                   ...
                   <li><a class="nav-link" href="consultarPermiso.jsp">Consultar Permiso</a></li>
                <li><a class="nav-link" href="consultarPermiso.jsp">Consultar Permisos Usuarios</a></li>
              </ul>
            </li>
            <li class="dropdown">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="consultarSancionJefe.jsp">Consultar Sanciones</a></li>
                <li><a class="nav-link" href="registrarSancionJefe.jsp">Registrar Sanción</a></li>
              </ul>
            </li>
          </ul>
        </aside>
          ...
          <div class="section-body">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                     ...
                     ArrayList<SancionVO>listaSanciones= SanDAO.listar();
            ...
            <tr>
                ...
                <td>
                    ...
                    <button value="11" class="btn btn-warning btn-block" name="opcion" >Editar</button>
                   
                     <input type="hidden"  name="textId" value="<%=SanVO.getIdSancion()%>">
                     <button value="10" class="btn btn-danger btn-block" onclick="Borrar(<%=SanVO.getIdSancion()%>)" name="opcion" >Eliminar</button>
                     </form>
                </td>
            </tr>
        </tbody>
                      ...
                      <form method="post" action="GenerarSancionPDF.jsp" target="_black">
                          <input type="hidden" >
                          <button class="btn btn-info btn-block">Generar Reporte en PDF</button>
                      </form>
            </div>
          </div>
        </section>
...
swal({
  ...
  text: "No podrás recuperar el dato una vez eliminado",
  type: "warning",
