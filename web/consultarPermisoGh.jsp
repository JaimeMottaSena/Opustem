<%-- 
    Document   : consultarPermisoGh
    Created on : 2/12/2021, 11:40:01 PM
    Author     : user
--%>
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="consultarPermisoGh.jsp">Consultar Permisos</a></li>
           ...
           <tbody>
            <tr>
                ...
                <td>
                    ...
                    <button value="8" class="btn btn-warning btn-block" name="opcion" >Editar</button>
                  ...
                  <form method="post" action="Permiso">
                     ...
                     <input type="text" name="textEstado" value="<%=PerVO.getEstadoPermiso().equals("aprobado")?"reprobado":"aprobado"%>">
                                            ...
                                            <button value="9"  class=" btn btn-info"  name="opcion" id="adf"  >
