...
<body>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="menu_Gerente.jsp"> <img alt="image" src="assets/img/opus.png" class="header-logo" /> <span
            ...
            <tr>
                ...
                <td>
                    ...
                    <button value="2" class="btn btn-warning btn-block" name="opcion" >Editar</button>
                     ...
                     <input type="hidden"  name="textId" value="<%=SanVO.getIdSancion()%>">
                     <button value="4" class="btn btn-danger btn-block" onclick="Borrar(<%=SanVO.getIdSancion()%>)" name="opcion" >Eliminar</button>
                     </form>
                </td>
            </tr>
        </tbody>
  ...
  <script>
    function Borrar(<%=SanVO.getIdSancion()%>){
swal({
