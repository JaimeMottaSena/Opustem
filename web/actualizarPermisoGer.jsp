<%-- 
    Document   : actualizarPermisosGer
    Created on : 2/12/2021, 11:44:33 PM
    Author     : user
--%>
...
<head>
  ...
  <title>Actualizar PermisoGer</title>
  <!-- General CSS Files -->
        ...
        <div class="container">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-2">
                    <label for=""></label>
                <button value="13" name="opcion" class="btn btn-info btn-block">Actualizar</button>
                                ...
                                <label for=""></label>
                                <button type="button" class="btn btn-dark"><a href="consultarPermisoGer.jsp">Volver</a></button>
